...
{
    const BUY_MORE_DISCOUNT_MORE = "buy-more-discount-more";
    /**
     * @var array
     */
    protected $classByType = [
        ...
        self::BUY_MORE_DISCOUNT_MORE =>
            \Eleadtech\AdvancePromotion\Model\SalesRule\Rule\Action\Discount\Formula::class
    ];
}
